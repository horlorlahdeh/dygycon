        ...
        <div className='container'>
          ...
          <div className='sponsors-section-cards'>
            <div className='row'>
              ...
              <div className='col-md-3'>
                <div className='speaker-card'>
                  <div className='speaker-card-image-3'>
                    {/* <img
                      src='https://cdn.discordapp.com/attachments/809089962829414441/812719222676520990/image_7.png'
                      alt='Justin Renken'
                      className='speaker-img text-center d-block m-auto'
                    /> */}
                  </div>
                  <div className='speaker-card-desc'>
                    <h5 className='speaker-name text-center'>Justin Renken</h5>
                    <p className='speaker-title text-center'>
                      ARK.io, Senior Brand Manager
                    </p>
                  </div>
                </div>
              </div>
