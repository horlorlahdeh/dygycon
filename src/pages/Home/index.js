          ...
          <div className='sponsors-section-cards'>
            <div className='row'>
              {sponsors.slice(0, limit).map((sponsor, index) => (
                <div className='col-md-3 sponsor-card-column' key={index}>
